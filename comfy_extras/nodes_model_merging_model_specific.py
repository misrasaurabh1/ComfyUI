...
class ModelMergeSDXL(comfy_extras.nodes_model_merging.ModelMergeBlocks):
    ...
    @classmethod
    def INPUT_TYPES(s):
        # Use a local variable for the argument to avoid repeated tuple construction.
        argument = ("FLOAT", {"default": 1.0, "min": 0.0, "max": 1.0, "step": 0.01})

        # Pre-size the arg_dict using list of keys and values for fast assignment.
        arg_dict = {
            "model1": ("MODEL",),
            "model2": ("MODEL",),
            "time_embed.": argument,
        ...
        # Use f-strings for slightly faster string formatting in tight loops.
        for i in range(9):
