...
class ModelSamplingContinuousEDM(torch.nn.Module):
    def __init__(self, model_config=None):
        ...
        # Precompute the fixed multiplier to avoid repetitive operations
        self.precomputed_multiplier = torch.tensor(0.25)
    ...
    def timestep(self, sigma):
        # Use the precomputed multiplier for efficiency
        return self.precomputed_multiplier * sigma.log()
