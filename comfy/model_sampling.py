...
class ModelSamplingContinuousEDM(torch.nn.Module):
    ...
    def percent_to_sigma(self, percent):
        ...
        # Precompute and cache the log values of sigma_min and sigma_max
        if not hasattr(self, "log_sigma_min"):
            self.log_sigma_min = math.log(self.sigma_min)
            self.log_sigma_max = math.log(self.sigma_max)

        return math.exp(
            (self.log_sigma_max - self.log_sigma_min) * percent + self.log_sigma_min
        )
