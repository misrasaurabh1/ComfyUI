...
class EPS:
    ...
    def calculate_denoised(self, sigma, model_output, model_input):
        # Use in-place operation for the view method
        sigma = sigma.view(-1, *(1,) * (model_output.dim() - 1))

        # In-place operation to reduce memory overhead and speed up computation
